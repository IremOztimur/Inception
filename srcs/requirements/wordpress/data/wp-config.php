...
/** MySQL database ioztimurname */
define( 'DB_USER', 'ioztimur' );

/** MySQL database password */
define( 'DB_PASSWORD', 'inception_db_123456' );
 ...
 * You can change these at any point in time to invalidate all existing cookies. This will force all ioztimurs to have to log in again.
 *
 * @since 2.6.0
 */
